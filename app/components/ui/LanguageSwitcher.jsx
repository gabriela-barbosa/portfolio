    ...
    <div className="fixed top-4 right-4 z-[60] flex items-center">
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          style={{ backgroundColor: '#191919', color: '#f5f5f5' }}
        >
        ...
        {open && (
          <ul
            className="absolute right-0 mt-1 w-full rounded-md border-2 overflow-hidden"
            ...
            {options.map((opt) => (
              <li key={opt.value}>
                <button
                  ...
                  style={{
                    backgroundColor: opt.value === lang ? '#333333' : '#191919',
                    color: '#f5f5f5',
                  }}
                >
                  {opt.label}
